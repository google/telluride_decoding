...
algorithms that form a well-tested baseline for people interested in decoding
(auditory) brain signals.
...
[here](https://github.com/google/styleguide/blob/gh-pages/pyguide.md).
